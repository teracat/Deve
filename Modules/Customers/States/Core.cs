...
{
    // Queries
    public async Task<ResultGetList<StateResponse>> GetAsync(StateGetListRequest? request, CancellationToken cancellationToken = default)
    {
    ...
    public async Task<ResultGetList<StateResponse>> GetAsync(CancellationToken cancellationToken = default)
    {
        var query = new GetList.Query(null, null, null, null, null, null);
        return await mediator.SendAsync(query, cancellationToken);
    }

    public async Task<ResultGet<StateResponse>> GetByIdAsync(Guid id, CancellationToken cancellationToken = default)
    {
    ...
    // Commands
    public async Task<ResultGet<ResponseId>> AddAsync(StateAddRequest request, CancellationToken cancellationToken = default)
    {
        if (request is null)
        {
    ...
    public async Task<Result> UpdateAsync(Guid id, StateUpdateRequest request, CancellationToken cancellationToken = default)
    {
        if (request is null)
        {
