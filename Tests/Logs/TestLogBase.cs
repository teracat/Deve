...
namespace Deve.Tests.Logs
{
    public abstract class TestLogBase
    {
        ...
        {
            var exception = Record.Exception(() => _logProvider.Error(new Exception("Sample exception")));
        ...
        {
            var exception = Record.Exception(() => _logProvider.Error(new Exception("Sample exception"), "Sample text"));
            Assert.Null(exception);
        }
        ...
        {
            var exception = Record.Exception(() => _logProvider.Error(new Exception("Sample exception"), null!));
