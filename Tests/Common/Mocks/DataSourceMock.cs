...
namespace Deve.Tests.Mocks
{
    internal class DataSourceMock : Mock<IDataSource>
    {
        public DataSourceMock()
        {
            ...
            Setup(d => d.Users.Add(It.IsAny<User>())).Returns<User>((c) => Add(c));
            ...
            Setup(d => d.Countries.Add(It.IsAny<Country>())).Returns<Country>((c) => Add(c));
            ...
            Setup(d => d.States.Add(It.IsAny<State>())).Returns<State>((c) => Add(c));
            ...
            Setup(d => d.Cities.Add(It.IsAny<City>())).Returns<City>((c) => Add(c));
            ...
            Setup(d => d.Clients.Add(It.IsAny<Client>())).Returns<Client>((c) => Add(c));
