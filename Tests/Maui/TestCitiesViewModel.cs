...
namespace Deve.Tests.Maui
{
    public class TestCitiesViewModel : TestListDataViewModel
    {
        ...
        protected override ListDataViewModel CreateViewModel(INavigationService navigationService, Internal.Data.IData data) => new CitiesViewModel(navigationService, data);
    }
}