...
namespace Deve.Tests.Maui
{
    public class TestClientsViewModel : TestListDataViewModel
    {
        ...
        protected override ListDataViewModel CreateViewModel(INavigationService navigationService, Internal.Data.IData data) => new ClientsViewModel(navigationService, data);
    }
}