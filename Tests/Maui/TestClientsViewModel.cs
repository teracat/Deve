...
public class TestClientsViewModel : TestListDataViewModel
{
    ...
    internal override ListDataViewModel CreateViewModel(INavigationService navigationService, Data.IData data, ISchedulerProvider scheduler) => new ClientsViewModel(navigationService, data, scheduler);
}