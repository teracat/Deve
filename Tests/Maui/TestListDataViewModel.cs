...
public abstract class TestListDataViewModel : IClassFixture<FixtureMaui>
{
    ...
    internal abstract ListDataViewModel CreateViewModel(INavigationService navigationService, Data.IData data);

    [Fact]
    public async Task Initialization_ValidAuthAdmin_HasNoError()
    {
        var viewModel = CreateViewModel(_fixture.NavigationService.Object, _fixture.DataAuthAdmin);
    ...
    public async Task SelectedData_NotNull_NavigatesToDetails()
    {
        ...
        var viewModel = CreateViewModel(navigationService.Object, _fixture.DataAuthAdmin);
        await viewModel.Initialization;
