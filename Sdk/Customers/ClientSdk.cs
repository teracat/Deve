...
{
    private const string Path = ApiConstants.PathClientV1;
    ...
    public async Task<Result> UpdateStatusAsync(Guid id, ClientUpdateStatusRequest request, CancellationToken cancellationToken = default) => await Patch(Path + id + ApiConstants.MethodSeparator + ApiConstants.MethodUpdateStatus, RequestAuthType.Default, request, cancellationToken);
